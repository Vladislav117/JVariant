...
public class BuildVariantClassTask extends DefaultTask {
    @TaskAction
    public void run() {
        File sourceCodeDirectory = new File(getProject().getProjectDir(), "src/main/java/ru/vladislav117/jvariant");

        // TODO: Move imports to JWriter methods

        String sourceCode = "";
        sourceCode += "package ru.vladislav117.jvariant;\n\n";
        sourceCode += "import com.google.gson.*;\n";
        sourceCode += "import org.jetbrains.annotations.Nullable;\n";
        sourceCode += "import ru.vladislav117.jvariant.error.*;\n";
        sourceCode += "\n";
